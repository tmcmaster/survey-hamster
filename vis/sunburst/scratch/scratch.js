(function(d3) {
    ...
    var f = h.append("svg").attr("width", i + 2 * c).attr("height", l + 2 * c)
        .append("g").attr("transform", "translate(" + [o + c, o + c] + ")");
    ...
    d3.sunburst = function(datafile) {
        d3.json(datafile, function(r, i) {
            function l(n) {
            ...
            var y = m.enter()
                        ...
                        .attr("text-anchor", function(t) {return d(t.x + t.dx / 2) > Math.PI ? "end" : "start"})
                        .attr("dy", ".2em")
            ...
            y.append("tspan")
                .attr("x", 0)
                .text(function(t) {return t.firstname});
            y.append("tspan")
                .attr("x", 0)
                .attr("dy", "1em")
                .text(function(t) {return t.lastname});
        });
    }
})(window.d3);